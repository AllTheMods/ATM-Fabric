...
execute if score @s pca_jrn_outsq matches 0 if score @s pca_jrn_output matches 1000.. run advancement grant @s only paint:adventure/transport/boat/frozen_freeway
execute unless score @s pca_jrn_outsq matches 0 if score @s pca_jrn_outsq <= @s pca_jrn_out+1sq if score @s pca_jrn_output matches 1000.. run advancement grant @s only paint:adventure/transport/boat/frozen_freeway
