...
execute if score @s pca_jrn_outsq matches 0 if score @s pca_jrn_output matches 200.. run advancement grant @s only paint:adventure/transport/saddle/the_carrot_and_the_stick
execute unless score @s pca_jrn_outsq matches 0 if score @s pca_jrn_outsq <= @s pca_jrn_out+1sq if score @s pca_jrn_output matches 200.. run advancement grant @s only paint:adventure/transport/saddle/the_carrot_and_the_stick
