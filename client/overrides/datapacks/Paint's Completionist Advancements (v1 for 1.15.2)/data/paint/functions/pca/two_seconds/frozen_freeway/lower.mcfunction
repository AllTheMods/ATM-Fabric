...
execute unless score @s pca_jrn_turns matches 21.. if score @s pca_jrn_outsq = @s pca_jrn_input run function paint:pca/two_seconds/frozen_freeway/rounding
execute unless score @s pca_jrn_turns matches 21.. if score @s pca_jrn_output = @s pca_jrn_out_old run function paint:pca/two_seconds/frozen_freeway/rounding
execute unless score @s pca_jrn_turns matches 21.. unless score @s pca_jrn_output = @s pca_jrn_out_old if score @s pca_jrn_outsq < @s pca_jrn_input run function paint:pca/two_seconds/frozen_freeway/higher
execute unless score @s pca_jrn_turns matches 21.. unless score @s pca_jrn_output = @s pca_jrn_out_old if score @s pca_jrn_outsq > @s pca_jrn_input run function paint:pca/two_seconds/frozen_freeway/lower