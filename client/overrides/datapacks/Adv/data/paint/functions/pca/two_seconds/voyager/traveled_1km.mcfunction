...
execute if score @s pca_jrn_wboat_x1 <= @s pca_jrn_x2 run scoreboard players operation @s pca_jrn_dx = @s pca_jrn_x2
execute if score @s pca_jrn_wboat_x1 <= @s pca_jrn_x2 run scoreboard players operation @s pca_jrn_dx -= @s pca_jrn_wboat_x1
execute if score @s pca_jrn_wboat_x1 > @s pca_jrn_x2 run scoreboard players operation @s pca_jrn_dx = @s pca_jrn_wboat_x1
execute if score @s pca_jrn_wboat_x1 > @s pca_jrn_x2 run scoreboard players operation @s pca_jrn_dx -= @s pca_jrn_x2
execute if score @s pca_jrn_wboat_z1 <= @s pca_jrn_z2 run scoreboard players operation @s pca_jrn_dz = @s pca_jrn_z2
execute if score @s pca_jrn_wboat_z1 <= @s pca_jrn_z2 run scoreboard players operation @s pca_jrn_dz -= @s pca_jrn_wboat_z1
execute if score @s pca_jrn_wboat_z1 > @s pca_jrn_z2 run scoreboard players operation @s pca_jrn_dz = @s pca_jrn_wboat_z1
execute if score @s pca_jrn_wboat_z1 > @s pca_jrn_z2 run scoreboard players operation @s pca_jrn_dz -= @s pca_jrn_z2
...
scoreboard players operation @s pca_jrn_outsq *= @s pca_jrn_output
execute if score @s pca_jrn_outsq = @s pca_jrn_input run function paint:pca/two_seconds/voyager/rounding
execute if score @s pca_jrn_outsq < @s pca_jrn_input run function paint:pca/two_seconds/voyager/higher
execute unless score @s pca_jrn_output = @s pca_jrn_out_old if score @s pca_jrn_outsq > @s pca_jrn_input run function paint:pca/two_seconds/voyager/lower