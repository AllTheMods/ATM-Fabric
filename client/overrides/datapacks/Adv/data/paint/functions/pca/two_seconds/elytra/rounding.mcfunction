...
execute if score @s pca_jrn_outsq matches 0 if score @s pca_jrn_output matches 5000.. run advancement grant @s only paint:adventure/transport/elytra/long_haul_flight
execute unless score @s pca_jrn_outsq matches 0 if score @s pca_jrn_outsq <= @s pca_jrn_out+1sq if score @s pca_jrn_output matches 5000.. run advancement grant @s only paint:adventure/transport/elytra/long_haul_flight
